...
from tools.comparar_jugadores import comparar_jugadores, comparar_maximos_goleadores
...
6. Si el usuario pide comparar maximos goleadores, pichichis o top scorers de ligas, usa comparar_maximos_goleadores
...
def crear_agente():
    ...
    if not llm_configurado():
        raise RuntimeError(
            "No hay API key configurada. Añade GROQ_API_KEY al .env."
        )
